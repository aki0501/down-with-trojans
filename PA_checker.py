...
def run_py_tests(test_dir):
    ...
    # return run_tests(python_executable + test_dir + "/version_2.py", test_dir, True)
...
def run_grid(test_dir):
    any_correct = False
    # if os.path.exists(test_dir + "/version_2.py"):
...
if __name__ == "__main__":
    ...
    your_repo_dir = '/Users/aki.hj/Projects/down-with-trojans'
